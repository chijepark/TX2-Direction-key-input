...
(cl:defmethod cl:initialize-instance :after ((m <MsgControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name con_esc-msg:<MsgControl> is deprecated: use con_esc-msg:MsgControl instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader con_esc-msg:data-val is deprecated.  Use con_esc-msg:data instead.")
  (data m))
